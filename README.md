...
Ingeniería y Calidad de Software · Grupo 1 · Curso 4K2 · 2026  
Repositorio grupal de la cátedra: materiales de clase, trabajos prácticos, trabajos de investigación y gestión de configuración del software (SCM).
...
- [⚙️ Ítems de configuración](#%EF%B8%8F-%C3%ADtems-de-configuraci%C3%B3n)
- [📖 Glosario](#-glosario)
- [🏷️ Criterio de línea base](#%EF%B8%8F-criterio-de-l%C3%ADnea-base)
- [📌 Líneas base disponibles](#-l%C3%ADneas-base-disponibles)
